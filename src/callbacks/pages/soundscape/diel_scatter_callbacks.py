...
def register_callbacks():
    ...
    clientside_callback(
        ...
        """,
        Output({"type": "index-scatter-data-download-button", "index": MATCH}, "loading", allow_duplicate=True),
        Input({"type": "index-scatter-data-download-button", "index": MATCH}, "n_clicks"),
        prevent_initial_call=True,
    )

    @callback(
        Output({"type": "index-scatter-data-download", "index": MATCH}, "data"),
        Output({"type": "index-scatter-data-download-button", "index": MATCH}, "loading"),
        State("dataset-select", "value"),
