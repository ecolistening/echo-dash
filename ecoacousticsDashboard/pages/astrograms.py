...
dash.register_page(__name__, title='Astrograms', name='Astrograms')

# Incorporate data
f = Path('/data/features.23D17.astrograms.parquet')
if not is_docker():
    f = Path('/Users/ca492/Documents/sussex/projects/ecoacoustics-dashboard/features.23D17.astrograms.parquet')
